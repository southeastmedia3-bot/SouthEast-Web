...
export const aboutStory = {
  ...
  paragraphs: [
    ...
    "The result is a studio that behaves like an embedded division — not a vendor. One pipeline, one standard, six disciplines.",
  ],
};
...
export const aboutPrinciples = [
  {
    ...
    detail: "The image has to be true before it is beautiful. We build to pass review, then we make it cinematic.",
  },
  {
    label: "One pipeline, one standard",
    detail: "Every vertical shares the same 8K colour science and the same zero-imperfection finish.",
  },
  {
    label: "Security as craft",
    detail: "NDA-bound, access-controlled, and auditable. Your work never leaves a secure environment.",
  },
  {
