 ...
 * whole body -> one system: scrolling cross-dissolves through them so the
 * complete figure strips back to a single system. Black-bg PNGs, so they sit
 * seamlessly on the section's black ground.
 *
 * The `detail` lines are deliberately order-neutral (they name each system
 * rather than saying "added" / "layered in"), so the sequence reads correctly
 * running down from Complete as much as it would running up.
 */
export const anatomyLayers = [
  { src: `${G_PHARMA}/10-full.png`, label: "Complete", detail: "Every system, fully rigged." },
  { src: `${G_PHARMA}/9-muscular.png`, label: "Muscular", detail: "Every muscle group." },
  {
    src: `${G_PHARMA}/8-skeletomuscular.png`,
    label: "Musculoskeletal",
    detail: "Muscle over bone.",
  },
  ...
  },
  {
    ...
    label: "Nervous",
    detail: "The neural network, head to foot.",
  },
  { src: `${G_PHARMA}/4-organs.png`, label: "Viscera", detail: "The organs, in the torso." },
  { src: `${G_PHARMA}/3-digestive.png`, label: "Digestive", detail: "The gut." },
  { src: `${G_PHARMA}/2-lungs.png`, label: "Respiratory", detail: "The lungs and airway." },
  { src: `${G_PHARMA}/1-kidney.png`, label: "Urinary", detail: "One system, in isolation." },
] as const;
